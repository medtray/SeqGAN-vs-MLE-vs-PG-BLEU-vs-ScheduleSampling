...
def main(generator_,PRE_EPOCH_NUM):
    ...
    np.save('perf_dict'+str(PRE_EPOCH_NUM), perf_dict)
...
if __name__ == '__main__':
    main(original_generator,200)
    main(original_generator, 400)
    main(original_generator, 800)
    main(original_generator, 1000)
