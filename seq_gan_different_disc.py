...
if __name__ == '__main__':
    ...
    nlayers=2
    nhid=64
    disriminator_lstmm=LSTM_Discriminator(d_num_class, VOCAB_SIZE, d_emb_dim, dropout_rnn, rnn_type, bidirection, nlayers, nhid)

    main(original_generator, disriminator_lstmm,1)

    discriminator = Discriminator(d_num_class, VOCAB_SIZE, d_emb_dim, d_filter_sizes, d_num_filters, d_dropout)
    main(original_generator, discriminator,2)
